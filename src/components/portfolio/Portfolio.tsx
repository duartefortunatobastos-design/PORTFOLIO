      ...
      <div className="mx-auto grid max-w-7xl gap-10 sm:gap-12 md:gap-14 lg:grid-cols-2 lg:gap-16">
        ...
        <FadeIn delay={120}>
          <form
            ...
            noValidate
            className="glass-card space-y-4 rounded-2xl border border-white/5 p-4 shadow-glow sm:space-y-5 sm:p-6 md:p-8"
          >
            <input
              id="contact-name"
              name="name"
              ...
              className="w-full rounded-xl border border-white/5 bg-brand-surface/60 px-4 py-3.5 text-base text-white placeholder:text-white/40 transition-all duration-300 focus:-translate-y-0.5 focus:border-brand-accent/50 focus:bg-brand-surface/80 focus:outline-none focus:shadow-glow sm:px-5 sm:py-4"
            />
            <input
              id="contact-email"
              name="email"
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-white/5 bg-brand-surface/60 px-4 py-3.5 text-base text-white placeholder:text-white/40 transition-all duration-300 focus:-translate-y-0.5 focus:border-brand-accent/50 focus:bg-brand-surface/80 focus:outline-none focus:shadow-glow sm:px-5 sm:py-4"
            />
            <button
              type="submit"
              disabled={submitting || !isComplete}
              className="min-h-11 w-full rounded-xl bg-brand-primary py-3.5 font-bold text-white transition-all duration-300 hover:scale-[1.01] hover:brightness-110 hover:shadow-glow disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:scale-100 sm:py-4"
            >
