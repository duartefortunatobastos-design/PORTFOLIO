...
const pt: Dict = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "Atualmente, procuro evoluir numa área que me motiva, articulando a exigência adquirida com foco na procura de novos desafios profissionais.",
    ],
...
const en: Dict = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "At present, I seek to grow in a field that motivates me, bringing together the standards I developed with a focus on new professional challenges.",
    ],
